CREATE (RincondelSteak:Restaurante {nombre: 'Rincón del Steak', ubicacion: 'Zona 9', precio: 'Alto', tipo_comida: ['Comida de mar', 'Comida internacional'], ambiente: ['Familiar', 'Romantico', 'Negocios'], tipo_servicio: ['Domicilio', 'A la mesa', 'Para llevar', 'Bar'], horario: 'Almuerzo'})
